...
public class MyTasksTests extends BaseTest {
    ...
    Map<String, String> objectData = requestProjectData.setObjectData(loginProject, passwordProject, nameProject, loginProject);
    ...
    void completeAppointDirector() {
        ...
        String taskId4 = processObject.GetActiveSubtasksTimer(loginProject, passwordProject, processId2, 3);
        assertThat(taskId4, is(notNullValue()));
        userTask.CompleteTask(loginProject, passwordProject, taskId4, true);
        String processId3 = processObject.GetActiveSubprocessesTimer(loginProject, passwordProject, processId2, 5);
        assertThat(processId2, is(notNullValue()));
        String taskId5 = processObject.GetActiveSubtasksTimer(loginProject, passwordProject, processId3, 3);
        assertThat(taskId4, is(notNullValue()));

        loginPage.login(loginDirector, passwordDirector);
        myTasks.OpenTask(taskId5);
        apointDirector.FillFormField(fioRukovoditel)
                .CompleteTask()
                .OperationComplete();
        objectService.DeleteObjectById(loginProject, passwordProject, objectId);
    }
